 ...
 * attack range.<br>
 * 3) it has an efficient ScannerLowest that keeps the scan angle as little as possible to get as new
 ...
 * <p>
 * 
 * This robot makes use of the Oldest Scanned melee ScannerLowest from the RoboWiki:<br>
